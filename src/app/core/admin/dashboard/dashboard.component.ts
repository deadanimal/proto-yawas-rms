...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  getCharts() {
    this.zone.runOutsideAngular(() => {
      this.getChartAdminDashBoardSemiPie();
      this.getChartAdminDashboardBar();
      this.getChartAdminDashboardPie();
    });
  }

  getChartAdminDashBoardSemiPie() {
    /* Chart code */
    // Themes begin
  ...
  getChartAdminDashboardPie() {
    ...
    let chart = am4core.create("chartdivadmindash3", am4charts.PieChart3D);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
