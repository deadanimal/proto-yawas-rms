...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  getCharts() {
    this.zone.runOutsideAngular(() => {
      ...
      this.getChartUserDashboardBar();
    });
  }

  getChartUserDashboardBar() {
    /* Chart code */
    // Themes begin
    ...
    let chart = am4core.create("chartdivuserdashboard1", am4charts.XYChart);
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendarUserDashboard"),
      {
